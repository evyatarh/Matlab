function [J,Theta1,Theta2, precentOfPrediction] = bp(Theta1, Theta2, X,y,max_iter, alpha,Lambda)
...
% Theta2 - updated weight matrix betwwn the hidden layer and the output layer (or
% second hidden layer)
%
% Usage:[J,Theta1,Theta2,precentOfPrediction] = bp(Theta1, Theta2, X,y,max_iter, alpha,Lambda)
%
...
ybin=zeros(size(delta3));       % delta's for the hidden layer
...
for q=1:max_iter
    ...
    if mod(q,100)==0
        p = ff_predict(Theta1, Theta2, X,y);
